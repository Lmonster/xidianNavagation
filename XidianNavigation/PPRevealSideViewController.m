...
@property const CGFloat DefaultOffset;// = 70.0;
@end
...
- (id) initWithRootViewController:(UIViewController*)rootViewController {
    ...
    if (self) {
        ...
        self.DefaultOffset = (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) ? 518.0 : 70.0;
...
- (void) pushViewController:(UIViewController*)controller onDirection:(PPRevealSideDirection)direction animated:(BOOL)animated completion:(void(^)())completionBlock{
    [self pushViewController:controller onDirection:direction withOffset:self.DefaultOffset animated:animated completion:completionBlock];
}
...
- (void) pushViewController:(UIViewController*)controller onDirection:(PPRevealSideDirection)direction animated:(BOOL)animated forceToPopPush:(BOOL)forcePopPush completion:(void(^)())completionBlock{
    [self pushViewController:controller onDirection:direction withOffset:self.DefaultOffset animated:animated forceToPopPush:forcePopPush completion:completionBlock];
}
...
- (void) pushOldViewControllerOnDirection:(PPRevealSideDirection)direction animated:(BOOL)animated completion:(void(^)())completionBlock{
    [self pushOldViewControllerOnDirection:direction withOffset:self.DefaultOffset animated:animated completion:completionBlock];
}
...
- (void) replaceAfterOpenedCompletelyAnimated:(BOOL)animated completion:(void(^)())completionBlock{
    [self replaceAfterOpenedCompletelyWithOffset:self.DefaultOffset animated:animated completion:completionBlock];
}
