//
//  CCCurriculumTeacherViewController.h
//  XidianNavigation
//
...
@interface CCCurriculumTeacherViewController : UIViewController <UIScrollViewDelegate, SliderPageControlDelegate, UITableViewDataSource, UITableViewDelegate>
